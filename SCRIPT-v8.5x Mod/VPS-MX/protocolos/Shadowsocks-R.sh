...
1)
msg -bar
wget --no-check-certificate -O Instalador-Shadowsocks-R.sh https://raw.githubusercontent.com/NDsVPN/VPS-MX_Oficial/main/LINKS-LIBRERIAS/Instalador-Shadowsocks-R.sh > /dev/null 2>&1
